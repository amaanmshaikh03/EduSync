import { CalendarClock, CheckCircle2, CalendarPlus, Edit3 } from "lucide-react";
            ...
            {confirmedSessions.map((session, i) => (
              ...
              >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-xs font-bold text-brand-600 hover:underline flex-shrink-0"
                >
